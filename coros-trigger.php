<?php
// coros-trigger.php
// Déclenche un sync manuel du daemon /opt/coros-sync depuis bioz.app.
// Vit à /var/www/bioz/coros-trigger.php sur le VPS, derrière Nginx.
// Le daemon est dans /opt/coros-sync (group www-data, perms 750/640) pour que PHP
// puisse l'exécuter sans toucher au /home/ubuntu.
...
// (à élargir si bioz devient multi-user)
...
// Lancer le sync (synchrone, prend ~3-5s)
$start = microtime(true);
$output = shell_exec('cd /opt/coros-sync && /usr/bin/node dist/sync.js 2>&1');
